...
`,
                ...
                {
                    logo: '/images/dice.png',
                    title: 'Мастер игры. Кто он?',
                    description: `
                        Со всеми сюжетами библиотеки Вас познакомит их создатель, Мастер пространства — Тимур! 

Тимур — Мастер с большой буквы, опыт которого более 10-ти лет! Его любовь к НРИ настолько необъятна, что он решил делиться ею со всеми, и показать, что ДнД не гикское увлечение. Тимур стал первым кто, открыл уютный уголок настольно ролевых игр в Красноярске, где создает новые миры со своими гостями!

Мастер известен не только своей способностью оживлять фэнтезийные миры с непревзойденным вниманием к деталям, но и стильными усами, которые придают аутентичность пространству! 

Харизматичный и неповторимый Мастер станет отличным проводником в самые потаённые  уголки твоего воображения!
                        `,
                },
            ],
