...
- когда все вышеперечисленные данные собраны воедино, можно и нужно писать в <a target="_blank" rel="noopener noreferrer nofollow" class='link-underline is-active' href='https://t.me/DungeonRoom_Master'>социальные сети Dungeon Room</a> для бронирования даты и времени!
`,
                },
                {
                    logo: '/images/dice.png',
